...
class Constants(BaseConstants):
    ...
    num_rounds = 1
    instructions_template = 'increasing_t2/Instructions.html'
...
class Player(BasePlayer):
    ...
    def CQ1_error_message(self, value):
        if value != 'Between 300 and 500':
            return 'In the graph, the number of daily infection cases is between 300 and 500.'
