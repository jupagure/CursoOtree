...
class Constants(BaseConstants):
    ...
    num_rounds = 1
    instructions_template = 'decreasing_t1/Instructions.html'
...
class Player(BasePlayer):
    ...
    def CQ1_error_message(self, value):
        if value != 'Between 600 and 800':
            return 'In the graph, the number of daily infection cases is between 600 and 800.'
    ...
    CQ4 = models.StringField(
        choices=['The study setting is hypothetical.',
                 ...
                 'It is expected to take 6 months to develop the new effective vaccine from now (day 310).'],
        widget=widgets.RadioSelect
    )
