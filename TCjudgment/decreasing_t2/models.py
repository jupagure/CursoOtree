...
class Constants(BaseConstants):
    ...
    num_rounds = 1
    instructions_template = 'decreasing_t2/Instructions.html'
...
class Player(BasePlayer):
    ...
    def CQ1_error_message(self, value):
        if value != 'Between 400 and 600':
            return 'In the graph, the number of daily infection cases is between 400 and 600.'
