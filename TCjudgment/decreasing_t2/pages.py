...
class Round_1(Page):
    ...
    def before_next_page(self):
        ...
        p.participant.vars['actual_10'] = 384
        p.participant.vars['forecast_10_error'] = p.forecast_10 - 384
        p.participant.vars['abs_forecast_10_error'] = abs(p.forecast_10-384)
...
class Round_2(Page):
    ...
    def before_next_page(self):
        ...
        p.participant.vars['actual_20'] = 275
        p.participant.vars['forecast_20_error'] = p.forecast_20 - 275
        p.participant.vars['abs_forecast_20_error'] = abs(p.forecast_20 -275)
...
class Round_3(Page):
    ...
    def before_next_page(self):
        ...
        p.participant.vars['actual_30'] = 209
        p.participant.vars['forecast_30_error'] = p.forecast_30 - 209
        p.participant.vars['abs_forecast_30_error'] = abs(p.forecast_30 - 209)
